...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::take_translator_selection,
            ...
            browser_automation::browser_automation_prepare,
            browser_automation::browser_automation_sessions,
            browser_automation::browser_automation_execute_js
        ])
